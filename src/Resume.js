...
const Header = () => (
  <Box mb={2} textAlign="center">
    <Typography variant="h4" component="h1" sx={{ pt: '20px', fontFamily: 'Times New Roman', fontWeight: 'bold', pb: '10px' }}>Peddi Shyam Kumar</Typography>
    <Typography variant="body1" component="p" sx={{ display: 'inline', margin: '0 10px' }}><LocalPhoneIcon /> +91 8179768852</Typography>
    <Typography variant="body1" component="p" sx={{ display: 'inline', margin: '0 10px' }}>
      <LinkedInIcon /> <a href="https://www.linkedin.com/in/peddishyamkumar" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'inherit' }}>linkedin.com/in/peddishyamkumar</a>
    </Typography>
    <Typography variant="body1" component="p" sx={{ display: 'inline', margin: '0 10px' }}>
      <a href="mailto:peddishyamkumar@gmail.com" style={{ textDecoration: 'none', color: 'inherit' }}><MailIcon /> peddishyamkumar@gmail.com</a>
    </Typography>
  </Box>
);
...
const ResumeSection = ({ title, content }) => (
  <Box mb={1}>
    <Typography variant="h5" component="h2" gutterBottom sx={{ fontFamily: 'Times New Roman', fontWeight: 'bold' }}>{title}</Typography>
...
const educationContent = (
  <Grid container spacing={2}>
    <Grid item xs={12}>
      ...
      •   Completed B. Tech., in Mechanical Engineering from Vardhaman College of Engineering, affiliated with Jawaharlal Nehru Technological University (JNTUH), in 2024.
</Typography>
<br></br>

<Typography variant="h6" style={{ fontSize:'medium',color: '#333' }}>
•  Completed Intermediate education with an aggregate of 9.34 CGPA from Narayana Junior College affiliated to Board of Intermediate Education, TG.
</Typography>
<br></br>
<Typography variant="h6" style={{ fontSize: 'medium', color: '#333' }}>
•  Completed Secondary School of education from Aryabhatta High School with an aggregate of 8.5 CGPA.
</Typography>
...
const certificates = (
  <Grid container spacing={2}>
    <Grid item xs={12}>
      ...
      • ICS | solid works 3D design software certificate in 2022.</Typography>
      <br></br>
      <Typography style={{ fontSize: 'medium', color: '#333' }}>
      • CAMPX |  TRUPEE: Worked on Trupee project to build various React components in 2024</Typography>
